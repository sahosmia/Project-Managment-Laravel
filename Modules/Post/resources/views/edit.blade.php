        ...
        <form action="{{ route('posts.update', $post) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center gap-2 text-xs text-gray-600 bg-gray-50 p-2 rounded border border-gray-200" id="attachment-{{ $attachment->id }}">
                        ...
                        <button type="button" class="text-red-500 hover:text-red-700 delete-attachment" data-id="{{ $attachment->id }}">
            ...
            <div class="flex justify-between items-center border-t pt-3">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('posts.index') }}" class="text-gray-500 px-4 py-1.5 text-sm font-medium hover:text-gray-700 transition">Cancel</a>
