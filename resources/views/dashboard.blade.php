    ...
    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-semibold text-gray-900 mt-1">{{ $pendingProjectsSupervisor }}</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 flex items-center justify-between">
            <div>
                <h2 class="text-lg font-medium text-gray-500">Rejected (Supervisor)</h2>
                <p class="text-3xl font-semibold text-gray-900 mt-1">{{ $rejectProjectsSupervisor }}</p>
            </div>
            <div class="p-3 bg-purple-100 rounded-full text-purple-600">
                <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
